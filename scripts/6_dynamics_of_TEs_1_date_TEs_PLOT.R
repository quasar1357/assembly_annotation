...
setwd("D:/Documents/Beruf & Ausbildung/Ausbildung/22-08 MSC Bioinf/Genome Organization and Annotation/6_dynamics_of_TEs_1_dating")
...
dat <- fread("pilon_bt2_flye.fasta.mod.out.landscape.Div.Rname.tab.sed")
